...
DATABASES = {
    'default': {
        ...
        'NAME': 'expensetracker_db',           # ← put your DB name here
        'USER': 'tlad',           # ← DB username
        'PASSWORD': '123',   # ← DB password (don’t be a numpty and hardcode this in prod)
        'HOST': 'db',              # ← or the IP of your db server
...
EMAIL_HOST_PASSWORD = '' #write app password here
